...
Use the local SQLite database as a generated search index that can be rebuilt
from git tracked files. Keep long-lived memory reviewable in Markdown or JSON.
